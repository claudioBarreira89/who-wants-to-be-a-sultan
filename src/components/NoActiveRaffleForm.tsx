...
const charities = [
  ...
  {
    address: "0x81af1BD3FC77EE13756FffF345F198751C7a0EA0",
  ...
  const { mutate: initPool, isLoading } = useMutation({
    mutationFn: async (args: CreateData) => {
      try {
        ...
        if (refetchRaffleInfo) refetchRaffleInfo();
    ...
    <div className="w-full">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="mt-4">
        <div className="flex flex-col my-4">
          <FormInput control={control} name="name" label="">
          ...
          <FormInput control={control} name="description" label="">
          ...
          <FormInput control={control} name="charityAddress" label="">
          ...
          <FormInput control={control} name="tokenAddress" label="">
